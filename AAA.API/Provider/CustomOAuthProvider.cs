...
namespace AAA.API.Provider
{
    public class CustomOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            if (client.ApplicationType == Models.ApplicationTypes.MobileApp)
            {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            {
                context.SetError("invalid_credential", "The user name or password are not supplied");
                return;
            }
            ...
            var oAuthIdentity = await user.GenerateUserIdentityAsync(userManager, "JWT").ConfigureAwait(false);
